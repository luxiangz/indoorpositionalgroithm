...
#include <stdio.h>
#define EXPORTING_MatSincplot 1
    ...
    mclOutputHandlerFcn print_handler)
{
  ...
  if (!mclmcrInitialize())
    return false;
  if (!GetModuleFileName(GetModuleHandle("MatSincplot"), path_to_dll, _MAX_PATH))
    return false;
    {
...
{
  return MatSincplotInitializeWithHandlers(mclDefaultErrorHandler, 
